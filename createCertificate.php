...
include('menu.php');
?>
<div style="margin-left:5%;"><h2>Note : You can change the data by clicking on the text.</h2></div>
<div style="border-style: groove;margin:3%;background-image:url(images/bgr1.png);background-repeat:no-repeat;;background-size:70%;background-position:center">
...
-->
<div style="margin-left:19%;display:inline;padding-right:18%"><img src="<?php echo $middleLogo; ?>" width="20%"></div>

<form action="createCertificate.php?cerID=<?php echo $cerID ?>" method="post" enctype="multipart/form-data" name="form" style="display:inline" >
<input type="file" accept="image/x-png" name="rightLogo" onchange="this.form.submit()" style="position:absolute;padding-top:10%;width:6.5%;display:inline"">
</form>
...
<div ><input type="text" value="<?php echo $candidate_name; ?>" style="display:inline;font-size:36px"></div>
...
<div style="display:inline"><input type="text" value="<?php echo $course; ?>" style="display:inline;border-style: none;width:30%;text-transform:uppercase;text-align:center;font-size:16px;font-weight:600"></div>
<div class="fixedText" style="display:inline"> <br>with '<div class="fixedText" style="display:inline"><strong><input maxlength="1" type="text" value="<?php echo $grade; ?>" style="display:inline;border-style: none;width:1%;text-transform:uppercase;text-align:center;font-size:16px;font-weight:600"></strong></div>' Grade</div>
<div><div class="fixedText" style="display:inline">Under </div> <input type="text" value="<?php echo $centre ?>" style="display:inline;border-style: none;width:50%;text-transform:uppercase;text-align:center"></div>
<div class="fixedText" style="display:inline">Conducted by </div><div style="display:inline"><input type="text" value="<?php echo $place; ?>" style="display:inline;border-style: none;width:70%;text-transform:uppercase;text-align:center"></div>
<div class="fixedText">This Program held</div>
<div class="fixedText"  style="display:inline">between </div><div class="fixedText" style="display:inline"><input style="border-style: none;width:20%;text-align:center" type="text" id="datepicker" value="<?php echo $dateFrom; ?>">and </div><div style="display:inline"><input style="border-style: none;width:10%;text-align:center" type="text" id="datepicker1" value="<?php echo $dateTo ?>"></div>

</center>
</div>
<div style="padding-top:15%"></div>
<div style="float:left;display:inline">Certificate No <input type="text" value="<?php echo $certificate_no; ?>" style="display:inline;border-style: none;text-align:left"></div>

<div style="padding-left:85%;display:inline"><strong>Head</strong></div>

<div style="text-align:left;">Date  <div style="display:inline"><input style="border-style: none;width:16%" type="text" value=<?php echo date("d-m-Y") ?>></div>
...
<!--sending details to print -->
<form action="previewCertificate.php?cerID=<?php echo $cerID ?>" method="post">
<input type="text" value="<?php echo $certificate_no; ?>" hidden="hidden" name="certificate_no">
<input type="text" value="<?php echo $candidate_name; ?>" hidden="hidden" name="candidate_name">
<input type="text" value="<?php echo $regd_no; ?>" hidden="hidden" name="regd_no">
<input type="text" value="<?php echo $course; ?>" hidden="hidden" name="course">
<input type="text" value="<?php echo $grade; ?>" hidden="hidden" name="grade">
<input type="text" value="<?php echo $centre; ?>" hidden="hidden" name="centre">
<input type="text" value="<?php echo $place; ?>" hidden="hidden" name="place">
<input type="text" value="<?php echo $dateFrom; ?>" hidden="hidden" name="dateFrom">
<input type="text" value="<?php echo $dateTo; ?>" hidden="hidden" name="dateTo">
<input type="text" value="<?php echo $date; ?>" hidden="hidden" name="date">

<br>
<center>
                <input type="submit" value="Preview Cerificate" class="special"  />
