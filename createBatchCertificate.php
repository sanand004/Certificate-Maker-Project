...
?>
<form action="createBatchCertificate.php?batch_id=<?php echo $batch_id ?>" method="post">
...
<div style="padding-left:57%;display:inline;"><strong>Skill and Assessment Certification</strong></div>
</div>
</div>
